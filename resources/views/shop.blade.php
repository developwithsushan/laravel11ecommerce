...
@section('content')
                                ...
                                <ul class="list list-inline mb-0">
                                    ...
                                    <li class="list-item">
                                        <span class="menu-link py-1">
                                            <input @if(in_array($category->id,explode(",",$f_categories))) checked="checked" @endif type="checkbox" name="categories" class="chk-category" value="{{ $category->id }}">
                                            {{ $category->name }}
                                        </span>
                    ...
                    <div class="accordion-item mb-4 pb-3">
                        ...
                        <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <div class="lis list-inline mb-0 brand-list">
                        ...
                        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="{{ route('shop.product.detail', $product->slug) }}"><img loading="lazy" src="{{ asset('uploads/products/') }}/{{$product->image}}" width="330"
                                                                        height="400" alt="{{ $product->name }}" class="pc__img"></a>
                                        </div>
                                        @foreach(explode(',',$product->images) as $img)
                                        <div class="swiper-slide">
                                            <a href="{{ route('shop.product.detail', $product->slug) }}"><img loading="lazy" src="{{ asset('uploads/products/') }}/{{$img}}"
    ...
    <form id="frmFilter" method="GET" action="{{ route('shop.index') }}">
        ...
        <input type="hidden" name="brands" id="hdbBrands">
