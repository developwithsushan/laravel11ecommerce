    ...
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <em>Manage Your Items List</em>
                ...
                <a href="javascript:" class="checkout-steps__item active">
                ...
                <div class="checkout-form">
                    <div class="billing-info__wrapper">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control" name="city" required="" value="{{ old('state') }}">
                        ...
                        <div class="sticky-content">
                            ...
                            <div class="checkout__payment-methods">
                                ...
                                <div class="policy-text">
                                    ...
                                    website, and for other purposes described in our <a href="javascript:" target="_blank">privacy
                                        policy</a>.
                                </div>
                            </div>
